# Contributing To fixdecoder_zig

Thank you for helping improve `fixdecoder_zig`. Contributions are easiest to review when they are focused, tested, documented, and safe for protected branches.
